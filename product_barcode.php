...
require "lib_barcode/BarcodeGenerator.php";
require "lib_barcode/BarcodeGeneratorHTML.php";
...
// ทดสอบการแสดงผล barcode
// echo barcode("S10_1678");
// exit();
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Barcode List</h1>
         <div class="card">
             <div class="row">
                 <?php
                        while($data = mysqli_fetch_assoc($query_product)){
                            echo "<div class='col-3 p-4'>";
                            echo barcode($data['productCode']);
                            echo "<br>";
                            echo "Code: ". $data['productCode'];
                            echo "<br>";
                            echo "Name: ". substr($data['productName'],4,20);
                            echo "<br>";
                            echo "Price: ".$data['buyPrice'];
                            echo "</div>";
                        }
                ?>
             </div>
