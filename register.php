              ...
              <form class="user" action="register.php" method="post">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="employeeNumber" name="employeeNumber" placeholder="Employee Number">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="jobTitle" name="jobTitle" placeholder="Job Title">
                  </div>
                </div>
  ...
  <script>
    $(function(){
      $("button#btnSubmit").click(function(){
        // รับค่าจากฟอร์ม
        var employeeNumber = $("input#employeeNumber").val();
          ...
          success:function(data){
            ...
            if(data=="register_success"){
              ...
              Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Your create account successfully',
              ...
              // แจ้งเตือน
              alert("ลองทะเบียนไม่สำเร็จ ลองใหม่");
            }
          }
        });
