...
/*
|--------------------------------------------------------------------------
| UPLOAD IMAGE WITHOUT ORIGINAL FILE
|--------------------------------------------------------------------------
|
| ฟังก์ชันอัพโหลดและย่อรูปโดยไม่เก็บไฟล์ต้นฉบับไว้
|
 */
    ...
    $thumbheight = "100")
{
    if (isset($_FILES[$inputname])) {
        ...
        if ($file_size > $maxfilesize) {
            $errors[] = "File size must be less than " . ($maxfilesize / 1000000) . " MB";
        }
...
|
 */
function genius_uploadimg_with_org(
    $inputname = "files", 
    $filename = "nofilename.jpg", 
    $filesize, 
    $filetmp, 
