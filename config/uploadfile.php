...
function genius_uploadimg($inputname = "files", $filename = "nofilename.jpg", $filesize, $filetmp, $filetype, $maxfilesize = "2000000", $orgdirectory = "uploadphotos", $thumbdirectory = "thumbphotos", $thumbwidth = "100", $thumbheight = "100")
{
